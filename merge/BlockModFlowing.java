...
public class BlockModFlowing extends BlockFluid
{
    /**
    ...
    protected BlockModFlowing(int par1, Material par2Material)
    {
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (this.blockMaterial == mod_CC.DarkWater && !par1World.worldProvider.isHellWorld)
        {
            var7 = 2;
        }
        ...
        if (var6 > 0)
        {
            ...
            if (this.numAdjacentSources >= 2 && this.blockMaterial == mod_CC.HolyWater)
            {
            ...
            if (this.blockMaterial == mod_CC.DarkWater && var6 < 8 && var10 < 8 && var10 > var6 && par5Random.nextInt(4) != 0)
            {
                var10 = var6;
                var8 = false;
            }
        ...
        {
            if (this.blockMaterial == mod_CC.DarkWater && par1World.getBlockMaterial(par2, par3 - 1, par4) == mod_CC.HolyWater)
            {
                par1World.setBlockWithNotify(par2, par3 - 1, par4, Block.blockDiamond.blockID);
    ...
    private boolean liquidCanDisplaceBlock(World par1World, int par2, int par3, int par4)
    {
        ...
        return var5 == this.blockMaterial ? false : (var5 == mod_CC.DarkWater ? false : !this.blockBlocksFlow(par1World, par2, par3, par4));
    }
