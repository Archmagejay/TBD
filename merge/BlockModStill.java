...
public class BlockModStill extends BlockFluid
{
    protected BlockModStill(int par1, Material par2Material)
    {
        super(par1, par2Material);
        this.setTickRandomly(false);

        if (par2Material == mod_CC.DarkWater)
        {
        ...
        if (this.blockMaterial == mod_CC.DarkWater)
        {
            ...
            if (var6 == 0)
            {
                ...
                for (int var9 = 0; var9 < 3; ++var9)
                {
                    ...
                    {
                        par1World.setBlockWithNotify(par2, par3 + 1, par4, Block.blockLapis.blockID);
                    }
                }
            }
        }
